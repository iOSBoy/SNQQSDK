Pod::Spec.new do |s|
  ...
  s.resources    = 'SDK2.9.5.1/TencentOpenApi_IOS_Bundle.bundle'
  s.vendored_frameworks = 'SDK2.9.5.1/TencentOpenAPI.framework'
  s.public_header_files = 'SDK2.9.5.1/TencentOpenAPI.framework/Headers/**/*.h'
end